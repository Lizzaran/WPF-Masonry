...
{
    internal class MasonryTile
    {
        #region Delegates

        public delegate void PositionChangedHandler(object sender, EventArgs.PositionChanged e);

        public delegate void SizeChangedHandler(object sender, EventArgs.SizeChanged e);

        #endregion

        private UserControl _element;

        public MasonryTile(UserControl element)
        {
            Element = element;
        }
        ...
        private void UpdateSize(Size previousSize)
        {
            ...
            OnSizeChanged(this, new EventArgs.SizeChanged(previousSize, new Size(Width, Height)));
        }
        ...
        private void UpdatePosition()
        {
            if (OnPositionChanged == null)
                return;
            OnPositionChanged(this, new EventArgs.PositionChanged(Position));
        }
